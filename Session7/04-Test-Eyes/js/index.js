...
function render() {
	...
	for (var i = 0; i < eyesNum; i++) {
		...
		if (mouseY<810) eyes[2].rotation.x = map_range(mouseY, 0, 175, 0, 0);
		else eyes[2].rotation.x = map_range(mouseY, 175, window.innerHeight,0, 1.14);
		...
		if (mouseY<810) eyes[4].rotation.x = map_range(mouseY, 0, 100, -1.14, -0.25);
		else eyes[4].rotation.x = map_range(mouseY, 100, window.innerHeight, -0.25, 0);
  }
